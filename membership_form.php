...
function membership_save_form() {
	...
	if(!form_check) {
		...
		if(form.membership_postal.value.length < 6 && form.membership_postal.value.length > 7) {
			alert("Invalid Postal Code.\n우편번호 오류");
			form.membership_postal.focus();
			form.membership_postal.style.borderColor = "#dd4b39";
			return false;
		}
		if(form.membership_bDay.value.length != 0 && form.membership_bDay.value.length != 10) {
			alert("Invalid Date of Birth.\n생년월일 오류");
			form.membership_bDay.focus();
			form.membership_bDay.style.borderColor = "#dd4b39";
			return false;
		}
...
<form name="form_membership" action="membership_review.php" method="post" accept-charset="utf-8">
	...
	<div id="white_wrapper" >
		...
		<div style="width: 80%; display: table;">
			<div id="form1_wrapper" >
				...
				<p>
					...
					Korean Name / 한글 성명
					<input class="textbox" type="text" name="membership_nameKor" placeholder="  ex. 홍길동" value="<?=$membership_nameKor; ?>">
				</p>
				<p>
					<strong>&#9632;&nbsp;Phone Number / 전화번호<em>*</em>&nbsp;&nbsp;</strong><br>
				...
				<p>
					<strong>&#9632;&nbsp;Email / 이메일<em>*</em>&nbsp;&nbsp;</strong><br>
				...
				<p>
					<strong>&#9632;&nbsp;Preferred Language / 언어<em>*</em>&nbsp;&nbsp;</strong><br>
			...
			<div id="form2_wrapper" >
				<p>
					<strong>&#9632;&nbsp;Current Address / 현재 거주 주소&nbsp;&nbsp;</strong><br>
					...
					-->
					<input class="textbox" type="text" name="membership_postal" placeholder=" Postal Code (A0A0A0)" style="width:140px;" onFocus="input_focus(this)" onblur="input_blur(this)" maxlength=7 value="<?=$membership_postal; ?>"><em>*</em>
				...
				<p>
					<strong>&#9632;&nbsp;Date of Birth / 생년월일&nbsp;&nbsp;</strong><br>
					...
					생일날 쇼핑시 포인트가 두배로 적립됩니다.<br>Double the points on your birthday.
				</p> 

				<p>
					<strong>&#9632;&nbsp;Number of Family Members / 가족수&nbsp;&nbsp;</strong><br>
		...
		<div id="form3_wrapper" style="margin:30px 70px;">
			<p style="font-size:14px;">
				<input type="checkbox" name="membership_agree" <?=(($membership_agree) ? "checked" : "" ); ?>> 상기의 내용으로 한남멤버쉽 가입 신청을 합니다.<em>*</em><br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I hereby apply for membership card in the HANNAM Supermarket.<em>*</em><br>
				<input type="checkbox" name="membership_weeklyFlyer" <?=(($membership_weeklyFlyer) ? "checked" : "" ); ?>> 상기 이메일 주소로 매주 금요일 발행되는 [주간세일광고] 정보를 받는데에 동의합니다.(옵션)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I would like to receive weekly E-Flyer.(Optional)<br>
				<input type="checkbox" name="membership_eventFlyer" <?=(($membership_eventFlyer) ? "checked" : "" ); ?>> 상기 이메일 주소로 다양한 행사 및 이벤트등의 쇼핑정보를 받는데에 동의합니다.(옵션)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I would like to receive various events and shopping tips by email.(Optional)<br>
				<!--중복등록 방지<em>*</em>  <input class="textbox" type="text" style="width:30px;"> = 97 왼쪽에 보이는 숫자를 입력하세요.-->
			</p>
		</div>

		<div id="submit_btn_div" style="padding-left:600px;"><button type="button" class="btn" style="cursor:pointer;" onClick="membership_save_form()">Next</button></div>
		</article>
	</div><!-- white_wrapper  -->
</div><!-- gray bg  -->
</form>
