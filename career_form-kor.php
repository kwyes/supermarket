	...
	<div id="white_wrapper" >
		<article>
			...
			<div id="form_wrapper" >
				...
				<input type="radio" name="career_gender" value="Male" style="vertical-align:middle;" <?=(($career_gender == "Male") ? "checked" : "" ); ?>> 남<br><br>
				<input type="radio" name="career_gender" value="Female" style="vertical-align:middle;" <?=(($career_gender == "Female") ? "checked" : "" ); ?>> 여
				<br><br><br>

				<p>
					<strong>&#9632;&nbsp;  집 전화번호</strong><em>*</em>&nbsp;&nbsp;<br>
				...
				<p>
					<strong>&#9632;&nbsp;  현재 거주 주소 </strong><em>*</em><br>
				...
				<p><strong>&#9632;&nbsp; 희망근무시간</strong><em>*</em><br></p>
				...
				<p><strong>&#9632;&nbsp;  근무희망분야</strong><br></p>
				<input name="career_workField[]" type="checkbox" style="vertical-align:middle;" value="Grocery" <?=((in_array("Grocery", $career_workField)) ? "checked" : "" ); ?>>  그로서리<br><br>
				<input name="career_workField[]" type="checkbox" style="vertical-align:middle;" value="Meat" <?=((in_array("Meat", $career_workField)) ? "checked" : "" ); ?>> 정육<br><br>
				<input name="career_workField[]" type="checkbox" style="vertical-align:middle;" value="Produce" <?=((in_array("Produce", $career_workField)) ? "checked" : "" ); ?>>  야채/과일<br><br>
				<input name="career_workField[]" type="checkbox" style="vertical-align:middle;" value="Hareware" <?=((in_array("Hareware", $career_workField)) ? "checked" : "" ); ?>>  하드웨어<br><br>
				<input name="career_workField[]" type="checkbox" style="vertical-align:middle;" value="Deli" <?=((in_array("Deli", $career_workField)) ? "checked" : "" ); ?>>  반찬<br><br>
				<input name="career_workField[]" type="checkbox" style="vertical-align:middle;" value="Customer Service" <?=((in_array("Customer Service", $career_workField)) ? "checked" : "" ); ?>>  고객지원<br><br>
				<input name="career_workField[]" type="checkbox" style="vertical-align:middle;" value="Office" <?=((in_array("Office", $career_workField)) ? "checked" : "" ); ?>>  매장업무총괄지원<br><br>
				<input name="career_workField[]" type="checkbox" style="vertical-align:middle;" value="Maintenance" <?=((in_array("Maintenance", $career_workField)) ? "checked" : "" ); ?>>  시설(유지/관리/보수)<br><br>
				<input name="career_workField[]" type="checkbox" style="vertical-align:middle;" value="Others" <?=((in_array("Others", $career_workField)) ? "checked" : "" ); ?>>  기타분야<br><br>
				<br>

				<p><strong>&#9632;&nbsp;  근무경력</strong><br></p>
				 관련분야<br>
				<input name="career_prevWork" class="textbox" type="text"  placeholder="  ex. 매장업무" style="width:200px; margin-top:3px;" value="<?=$career_prevWork; ?>">
				<br><br>
				 근무기간(개월) <br>
				<input name="career_prevWorkMonth" class="textbox" type="text"  placeholder="  ex. 5" style="width:50px;margin-top:3px;margin-right:3px;" onkeyup="this.value=this.value.replace(/[^0-9-]/g,'');" onkeypress='return ((event.charCode >= 48 && event.charCode <= 57))' value="<?=$career_prevWorkMonth; ?>"> 개월<br><br>
				<input name="career_workPastYear" type="checkbox" style="vertical-align:middle;" <?=(($career_workPastYear) ? "checked" : "" ); ?>><span style="line-height:200%;">  최근 1년이내에 근무경력 있을시 체크</span><br><br>
				<br>

				<p><strong>&#9632;&nbsp;  자기소개서 첨부(1페이지)<br></p></strong><br>
				...
				<p><strong>&#9632;&nbsp;  이력서 첨부(1페이지)<br></p></strong><br>
